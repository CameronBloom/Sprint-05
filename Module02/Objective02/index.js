...
const docContainerButton = document.querySelectorAll(".button");
...
docContainerButton[0].addEventListener("click", (event) => { 
...
docContainer[0].addEventListener("mouseenter", (event) => {
...
docContainer[0].addEventListener("mouseleave", (event) => {
  event.target.style = "";
  event.target.style = "";
  // console.log(event.currentTarget.nodeName);
})
